...
local vehshop = {
	...
	menu = {
		...
		["Police"] = {{permissions={"police.vehicle"}}
			title = "Police",
			name = "Police",
			buttons = {
				{name = "Cadet", description = ''},
				{name = "General", description = ''},
				{name = "Unmarked", description = ''},
				{name = "Police SUV", description = ''},
				{name = "K9", description = ''}
			}
		},
		["Vehicles"] = {
			...
			buttons = {
				...
				{name = "Classic Sports", description = ''},
				{name = "Supercars", description = ''},
			...
			for i,button in pairs(menu.buttons) do
				if i >= vehshop.menu.from and i <= vehshop.menu.to then
					...
					if button.costs ~= nil then
						if vehshop.currentmenu == "Compacts" or vehshop.currentmenu == "Coupes" or vehshop.currentmenu == "Sedans" or vehshop.currentmenu == "Sports" or vehshop.currentmenu == "Classic Sports" or vehshop.currentmenu == "supers" or vehshop.currentmenu == "Muscle" or vehshop.currentmenu == "Offroad" or vehshop.currentmenu == "Suvs" or vehshop.currentmenu == "Vans" or vehshop.currentmenu == "industrial" or vehshop.currentmenu == "cycles" or vehshop.currentmenu == "Motorcycles" then
...
function vehSR_ButtonSelected(button)
	...
	elseif this == "Compacts" or this == "Coupes" or this == "Sedans" or this == "Sports" or this == "Classic Sports" or this == "supers" or this == "Muscle" or this == "Offroad" or this == "Suvs" or this == "Vans" or this == "industrial" then
