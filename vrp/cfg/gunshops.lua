...
["Paleto"] = {
    ...
    ["WEAPON_BOTTLE"] = {"Bottiglia",10,0,""},
    ["WEAPON_BAT"] = {"Bat",50,0,""},
    ["WEAPON_KNUCKLE"] = {"Tira Pugni",100,0,""},
    ["WEAPON_KNIFE"] = {"Coltello",50,0,""},
    ["WEAPON_MARKSMANPISTOL"] = {"Marksman Pistol",1500,2,""},
    ["WEAPON_SNSPISTOL"] = {"Pistola",2500,2,""},
    ["WEAPON_VINTAGEPISTOL"] = {"Pistola Vintage",2500,2,""},
    ["WEAPON_PISTOL"] = {"Pistola",2500,2,""},
    ["WEAPON_COMBATPISTOL"] = {"Pistola Combattimento",5000,2,""},
    ["WEAPON_HEAVYPISTOL"] = {"Pistola Pesante",5000,2,""},
    ["WEAPON_APPISTOL"] = {"Pistola Ap",7500,2,""},
    ["WEAPON_DAGGER"] = {"Pugnale",100,0,""},
    ["WEAPON_HAMMER"] = {"Martello",50,0,""},
    ["WEAPON_HATCHET"] = {"Accetta",100,0,""},
